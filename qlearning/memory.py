# Code taken from https://github.com/farizrahman4u/qlearning4k
...
class ExperienceReplay:
    ...
    # This method saves the given parameters as a flat matrix in memory array, and deletes the first element in the list
    # , if the memory array gets larger than specified
